...
`;
const MobileMenuDropdownLink = styled(Link)`
    font-size: 17px;
    margin-bottom: 0;
    ...
    color: darkgray;
`;
const MobileMenuDropdownLinkText = styled(MobileMenuLinkText)`
    border-radius: 0;
    font-size: 17px;
`;
...
export const MobileMenuStyle = {
    MobileMenuBlock: MobileMenuBlock,
    LogoText: LogoText,
    MobileMenuLinkWrapper: MobileMenuLinkWrapper,
    MobileMenuLink: MobileMenuLink,
    MobileMenuLinkText: MobileMenuLinkText,
    MobileMenuDropdown: MobileMenuDropdown,
    MobileMenuDropdownLink: MobileMenuDropdownLink,
    MobileMenuDropdownLinkText: MobileMenuDropdownLinkText,
