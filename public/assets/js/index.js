const indexAnimation = () => {
    ...
    if (!isMobileScroll) {
        ...
        const listAdvIcon = gsap.utils.toArray(
            ".listAdvantages_block_item_icon"
        );
        ...
        servicesItems.forEach((servicesItem, i) => {
            ...
            const animservices = gsap.from(servicesItem, {
                duration: duration,
                xPercent: -30,
                autoAlpha: 0,
                paused: true,
    ...
    if (document.querySelector(".contact_map") !== null) {
        document
