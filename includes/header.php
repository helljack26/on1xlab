<!-- Loader -->
<div id="preloader">
    <img src="images/icons/onixlab_logo.svg" class='preloader_block_logo' height="150px" alt="logo">
</div>
...
<header>
    <div class="header_row">
        <!-- Burger button -->
        <button type="button" class="header_hamburger">
            <span></span>
            <span></span>
            <span></span>
        </button>
        ...
        <div class="header_logo">
            <a class="header_logo_link" href="#">
                <img src="images/icons/onixlab_logo.svg" alt="logo">
            </a>
        </div>
    </div>
    ...
    <div class="header_social">
        <div class="tooltip" data-type="amras">
            <!-- Icon -->
        ...
        <a class="header_social_link telegram_icon" href="https://t.me/onixlab_ua" target="_blank">
        </a>

        <a class="header_social_link viber_icon" href="viber://chat?number=0982142238">
        </a>

        <a class="header_social_link facebook_icon"
        ...
        <a class="header_social_link instagram_icon" href="https://www.instagram.com/onixlab_ua" target='_blank'>
        </a>
    </div>
